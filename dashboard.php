            ...
            <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
              <table class="w-full text-left">
                ...
                <tr>
                  ...
                  <td class="py-5 text-right">
                    <div class="flex justify-end">
                      <a href="#" class="text-sm font-medium leading-6 text-indigo-600 hover:text-indigo-500">View<span
                            class="hidden sm:inline"> transaction</span><span
                            class="sr-only">, invoice #00012, Reform</span></a>
                    </div>
                    <div class="mt-1 text-xs leading-5 text-gray-500">Invoice <span class="text-gray-900">#00012</span>
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="py-5 text-right">
                    ...
                    <div class="mt-1 text-xs leading-5 text-gray-500">Invoice <span class="text-gray-900">#00011</span>
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="py-5 text-right">
                    ...
                    <div class="mt-1 text-xs leading-5 text-gray-500">Invoice <span class="text-gray-900">#00009</span>
                    </div>
                  </td>
                </tr>
